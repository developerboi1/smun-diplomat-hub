...
const DelegateInfo = () => {
  ...
  const handleRegisterNow = () => {
    window.open('https://docs.google.com/forms/d/e/1FAIpQLSeMd6J4r_huRkDZuuLHkdyqLBwlpr1sw7fJfM_ISHdeqEX5-A/viewform', '_blank');
  };

  const handleDownloadBrochure = () => {
    window.open('https://linktr.ee/samvidhanamsurat', '_blank');
  };
